Getting started
===============
1. `git clone https://github.com/LawrenceJones/d3-template.git my-d3-project && cd $_ && rm -rf .git` - gets this source locally & deletes .git folder, thus making it a simple folder
